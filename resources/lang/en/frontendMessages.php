...
return [
    ...
    'EXCEPTION_MESSAGES' => [
        ...
        'DELETE_USER_MESSAGE' => 'Logged in user can not be deleted !',
        ...
        'SHOW_USERS_LIST' => 'Some thing is wrong while fetching users !',
    ],
    ...
    'SUCCESS_MESSAGES' => [
        ...
        'USERS_EXPORTED' => 'Your export request has been received. You will get an email with download link in 15 minutes.'
    ],
];
